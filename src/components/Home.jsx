...
import ProfileImg from "../assets/images/picofme (1).png";
...
import email from "../assets/images/project/email.png";
import linkedIN from "../assets/images/project/linkedin.png";
import git from "../assets/images/project/github.png";

import JessicaMainImg from "../assets/images/picofme (7).png";
import CircularImg from "../assets/images/circular-img.png";
import FlowerImg from "../assets/images/flower.png";
import BrandLogo1 from "../assets/images/html-5.png";
import BrandLogo2 from "../assets/images/css-3.png";
import BrandLogo3 from "../assets/images/js.png";
import BrandLogo4 from "../assets/images/physics.png";
import BrandLogo5 from "../assets/images/icons8-tailwind-css-100.png";
import BrandLogo6 from "../assets/images/bootstrap.png";
import BrandLogo7 from "../assets/images/wordpress.png";
import BrandLogo8 from "../assets/images/php.png";
import AboutSection from "./About";
import Resume from "./Resume";
import Portfolio from "./Portfolio";
import Contact from "./Contact";
import $ from "jquery";
import CV from "../assets/pdf/jagna new resume 2025.pdf";
    ...
    <>
      ...
      <div className="side-menu">
        <div className="profile-img-main">
          ...
          <h1 className="fade_up">
            Jagan <span>Natarajan</span>
          </h1>
          <h2 className="designer fade_up">{firstTexts[firstTextIndex]}</h2>
          <div className="profile-media-icons-main fade_up">
            <img className="smallIcons" src={email} alt="" />
            <img className="smallIcons" src={git} alt="" />
            <img className="smallIcons" src={linkedIN} alt="" />
            {/* <div>
              <img className="smallIcons" src={email} alt="" />
              <img className="smallIcons" src={email} alt="" />
              <img className="smallIcons" src={email} alt="" />
      ...
      <div className="main-containe" data-bs-spy="scroll">
          ...
          <div className="row">
            <div className="col-xxl-6 col-lg-6">
              ...
              <p className="best fade_down">
                Aspiring Web Developer and Programmer passionate about creating
                scalable, efficient, and user-friendly web solutions using
                modern technologies like React, Redux, Next.js, and Tailwind
                CSS.
              </p>
        ...
        <section className="Marquee-main overflow-hidden">
          <h3 className="fade_up">Skills</h3>
          <div className="logos logos2">
            <div className="logos-slide">
              <div className="marquee__content">
                ...
                <div className="marquee-img-main">
                  <div className="flex1">
                    <img className="brand-logos" src={Git} alt="brand-logo6" />
                ...
                <div className="marquee-img-main">
                  <div className="flex1">
                    {/* <img
                      ...
                      alt="brand-logo6"
                    /> */}
                    <p className="text-white">fdfdfdf</p>
                  </div>
                </div>
              </div>
            </div>
